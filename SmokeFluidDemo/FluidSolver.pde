class FluidSolver {
  ...
  void addMouseForce(){
    ...
    leftCell.vy[newVals] = 0.0;
    leftCell.vx[newVals] = -100.0;
    
    topCell.vy[newVals] = -100.0;
    topCell.vx[newVals] = 0;
    
    rightCell.vy[newVals] = 0.0;
    rightCell.vx[newVals] = 100.0;
    
    botCell.vy[newVals] = 100.0;
    botCell.vx[newVals] = 0.0;
    
    topRightCell.vy[newVals] = -70.0;
    topRightCell.vx[newVals] = 70.0;  
    
    botRightCell.vy[newVals] = 70.0;
    botRightCell.vx[newVals] = 70.0;  
    
    topLeftCell.vy[newVals] = -70.0;
    topLeftCell.vx[newVals] = -70.0;
    
    botLeftCell.vy[newVals] = 70.0;
    botLeftCell.vx[newVals] = -70.0;
